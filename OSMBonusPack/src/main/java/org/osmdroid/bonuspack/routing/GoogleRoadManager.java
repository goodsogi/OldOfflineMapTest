...
public class GoogleRoadManager extends RoadManager {
	...
	private static final String GOOGLE_DIRECTIONS_SERVICE = "http://maps.googleapis.com/maps/api/directions/xml?";
	
	/**
	 * Build the URL to Google Directions service returning a route in XML format
	 */
	private String getUrl(ArrayList<GeoPoint> waypoints, boolean getAlternates) {
	 ...
	 * @return the roads
	 */
	private Road[] getRoads(ArrayList<GeoPoint> waypoints, boolean getAlternate) {
	...
	private Road[] getRoadsXML(InputStream is) {
...
class GoogleDirectionsHandler extends DefaultHandler {
	...
	private Road mCurrentRoad;
	private RoadLeg mLeg;
	RoadNode mNode;
